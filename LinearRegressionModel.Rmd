...
Now recall from the analysis of the individual scatterplots of price against the predictors that sqft_living, sqft_lot, and yr_built have no linear relationship with price. We apply a log-transformation to these predictors.
...
```
### Conclusion
Our linear regression model of price resulted in an R^2 of 0.4918, meaning that almost half of the variability in price is explained by a linear relationship with the predictors. The root mean squared error is 149859.20, so the average prediction of price is about $150,000 off. 
