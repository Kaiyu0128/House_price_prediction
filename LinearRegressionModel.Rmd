...
```{r}
data <- read.csv('~/Desktop/House_Price_Prediction/data.csv',stringsAsFactors = TRUE)
str(data)
summary(data)
```
...
```
### Conclusion
Our linear regression model of price resulted in an R^2 of 0.4906, meaning that almost half of the variability in price is explained by a linear relationship with the predictors. The root mean squared error is 149852.6, so the average prediction of price is about $150,000 off. 
