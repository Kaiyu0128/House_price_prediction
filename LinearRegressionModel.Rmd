...
# Check normality of log(price) 
shapiro.test(log(seattle.df$price))
```
From the summary: the minimum house price in Seattle is 90,000, the median is 490,000, the mean is 584295, and the maximum is 12,899,000. Price is heavily skewed right.
...
Price appears positively correlated with all predictors except yr_built. 
