...
train$renovated <- as.integer(train$renovated > 0)  # binary indicator of renovation
train$yr_built <- NULL
train$renovated <- NULL

test$age_of_house <- max(test$yr_built) - test$yr_built
test$renovated <- as.integer(test$renovated > 0)  # binary indicator of renovation
test$yr_built <- NULL
