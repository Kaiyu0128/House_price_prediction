...
library(mgcv)
# Fit the model
gam_model <- gam(price ~ s(bedrooms, k = 3) + s(bathrooms, k = 3) + s(sqft_living, k = 3) + s(sqft_lot, k = 3) + 
                 s(floors, k = 2) + s(condition, k = 2) + s(yr_built, k = 3) + s(yr_renovated, k = 2), data = data_train)
